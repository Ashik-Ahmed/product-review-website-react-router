...
const Blogs = () => {
    return (
        <div className='md:mx-10'>
            <div className='bg-white py-6 p-3 md:px-16'>
            ...
            <div className='bg-white py-6 mt-10 px-3 md:px-16'>
            ...
            <div className='bg-white py-6 my-10 p-3 md:px-16'>
                ...
                <table className='table-auto border-2 w-full'>
                    ...
                    <tbody>
                        <tr className='bg-gray-100 md:hover:bg-blue-300'>
                        ...
                        <tr className='md:hover:bg-blue-300'>
