        ...
        <div>
            <div className='md:flex justify-between items-center md:mx-20'>
                <div className='w-full md:w-3/4 md:px-16'>
                    <h1 className='text-5xl leading-tight tracking-tight font-extrabold'>A BRIEF HISTORY OF TIME</h1>
                    <h3 className='text-3xl text-orange-400 leading-tight tracking-tight font-bold text-center mb-8'>- Stephen Hawking</h3>
                    ...
                    <button className='text-lg font-semibold bg-transparent hover:bg-orange-400 border-2 border-blue-400 py-2 px-4 rounded-3xl mt-8 shadow-xl'>Order Now</button>
                </div>
                <div className='border-8 border-orange-400 shadow-lg'>
